        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="fw-bold my-4 h4">
                <ol class="breadcrumb justify-content-center">
                    <?php if (isset($_GET['major'])):?>

                    <li class="breadcrumb-item"><a class="text-decoration-none" href="../majors.php">majors</a></li>
                    <?php else:?>
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="../index.php">Home</a></li>
                    <?php endif;?>
                    <li class="breadcrumb-item active" aria-current="page"><?= mysqli_fetch_array($major)[0] ?></li>
                </ol>
            </nav>
            <div
            ...
            <div class="doctors-grid">
                <?php if(mysqli_num_rows($doctors) > 0): foreach($doctors as $doctor): ?>
                <div class="card p-2" style="width: 18rem;">
                    <img src="../Admin/uploads/<?= $doctor['image'] ?>" class="card-img-top rounded-circle card-image-circle"
                        alt="major">
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center"><?= $doctor['name'] ?></h4>
                        <h6 class="card-title fw-bold text-center"><?= mysqli_fetch_array(getMajor($doctor['major_id']))[0] ?></h6>
